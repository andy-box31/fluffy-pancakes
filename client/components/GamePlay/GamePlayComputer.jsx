...
class GamePlayComputer extends React.Component {
  constructor (props) {
    ...
    this.handleEndPauseForComputer = this.handleEndPauseForComputer.bind(this)
              ...
              <div className='grid'>
                ...
                <div className='infoTop'>
                  ...
                  {isPlayer2 && pauseForComputer &&
                    <>
                      <p>She's thinking..... </p>
                      <button type='button' className='glbFullAbsolute fullPageButton' onClick={this.handleEndPauseForComputer}>Continue</button>
                    </>}
                  {revealCards &&
